...
public class HallController {
	...
	public ResponseEntity<String> updateHallBySeatsNo(@PathVariable Integer hallId, @RequestBody HallDTO hall)throws HallNotFoundExcepiton {
	hallServices.updateHallBySeatsNo(hallId, hall.getSeatsNo());
